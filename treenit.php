            ...
            <div class="w3-modal-content w3-card-4 w3-animate-top">
                ...
                <div class="w3-container">
                    <div class="w3-container w3-card-4 w3-padding-16 ">
                        ...
                        <p>Dr. Nūn Sava-Siva Amen-Ran määritelmän mukaan hyvä ruokavalio on <b>optimaalinen ruokavalio</b>, joka teoreettisesti tai todistettavissa takaa maksamaalisen pitkäikäisyyden ja vireyden, vastustuskyvyn paranemisen ja neurokogtiviisisen toiminnallisuuden säilyttämisen tai lisäämisen.
                            Tärkein puoli ravinnosta on elintärkeiden ravinteiden saaminen.

                        </p>
                        <h5><b>Meal planner</b></h5>
                        <p>Scoobilta löytyy ohjelma, josta voi laskea mm. päivittäisen proteiinin, kalorien ja rasvan tarpeen riippuen tavoitteesta. http://scoobysworkshop.com/weight-loss-meal-planner/ </p>
            ...
            <div class="w3-modal-content w3-card-4 w3-animate-top">
                ...
                <div class="w3-container">
                    <div class="w3-container w3-card-4 w3-padding-16">
                        ...
                        <p>Vatsalihakset ovat siinä mielessä erilainen lihasryhmä kuin muut, koska ne ovat rakentuneet ja tottuneet tekemään jatkuvasti töitä. Vatsalihakset pitävät yölläkin kehoa koossa. Niitä voi ja kannattaakin treenata joka päivä. Vatsalihasten tehtävänä ei ole pystyä tekemään suurella painolla vatsalihasliikkeitä, vaan...</p>
                        <p>Jalkatreenit</p>
            ...
            <div class="w3-container w3-padding-small w3-center" id="Käsitreenit">
                ...
                <div class="w3-third w3-margin-bottom">
                    <ul class="w3-ul w3-border w3-hover-shadow">
                        ...
                        <iframe width="100%" height="344" src="https://www.youtube.com/embed/' . stripslashes($row['videourl']) . '" frameborder="0" allowfullscreen>
                        </iframe>
