...
<html lang="fi">
    ...
    <body id="myPage" class="backgroundimg">
        ...
        <div id="id01" class="w3-modal">
            <div class="w3-modal-content w3-card-4 w3-animate-top">
                ...
                <div class="w3-container">
                    <form class="w3-container w3-card-4 w3-padding-16 w3-white fontti" method="post" action="profile.php" enctype="multipart/form-data">
                        <?php
                        $config = parse_ini_file("../../config.ini");
                        $conn = mysqli_connect($config['dbaddr'],$config['username'],$config['password'],$config['dbname'],$config['dbport']);
                        // Check connection
                        ...
                        <div class="w3-container pad2">
                            <label class="w3-left labels">Sukupuoli
                                <select class="inputs w3-right" name="gender">
                        ...
                        <div class="w3-container pad2">
                            <label class="w3-left labels">Minusta
                                <input type="text" style="height:auto" class="w3-input w3-right" name="minusta" maxlength="500" value="<?= $rowU['bio'] ?>">
                            </label>
                            <br> 
                        </div>
        ...
        <div class="w3-row w3-row-padding-64 margtopbottom">
            <form action="profile.php" method="post" class="w3-container w3-padding w3-card-4 center3 profiili fontti pad">
                <div class="w3-container w3-center pad2">
                    <?php echo "<h1><em>" . $_SESSION['first'] . "</em></h1>";?>
                </div>
                <hr>
                <div class="w3-container pad2">
                ...
                <div class="w3-container w3-center pad2">
                    ...
                    <a class="pad3" href="https://www.terveyskirjasto.fi/terveyskirjasto/tk.koti?p_artikkeli=dlk01001">Lue lisää painoindeksistä.</a>
                </div>
                <hr>
                <div class="w3-container pad2">
                    <label>Kerro jotain itsestäsi <i class="fa fa-smile-o fa-fw"></i>
                        <textarea cols="30" rows="5" maxlength="250" class="w3-left w3-input area" readonly><?php echo $row["bio"];?></textarea>
                    </label>
                </div>
                <div>
